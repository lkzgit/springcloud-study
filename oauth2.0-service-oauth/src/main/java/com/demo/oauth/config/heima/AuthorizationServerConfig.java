...
class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private com.demo.oauth.config.CustomUserAuthenticationConverter customUserAuthenticationConverter;
...
//                .scopes("app");                         //客户端范围，名称自定义，必填
     ...
     */
    @Bean
    public JwtAccessTokenConverter jwtAccessTokenConverter(com.demo.oauth.config.CustomUserAuthenticationConverter customUserAuthenticationConverter) {
